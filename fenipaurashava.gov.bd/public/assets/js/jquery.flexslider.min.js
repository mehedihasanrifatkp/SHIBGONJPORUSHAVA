    ...
    e.flexslider = function(t, n) {
        ...
        e.data(t, "flexslider", a), m = {
            ...
            touch: function() {
                ...
                function v(t) {
                    r = l ? e - t.touches[0].pageY : e - t.touches[0].pageX, (!(m = l ? Math.abs(r) < Math.abs(t.touches[0].pageX - n) : Math.abs(r) < Math.abs(t.touches[0].pageY - n)) || Number(new Date) - p > 500) && (t.preventDefault(), !u && a.transitions && (i.animationLoop || (r /= 0 === a.currentSlide && r < 0 || a.currentSlide === a.last && r > 0 ? Math.abs(r) / s + 2 : 1), a.setProps(o + r, "setTouch")))
                }

                function f(l) {
                    if (t.removeEventListener("touchmove", v, !1), a.animatingTo === a.currentSlide && !m && null !== r) {
                        var d = c ? -r : r,
                            g = d > 0 ? a.getTarget("next") : a.getTarget("prev");
                        a.canAdvance(g) && (Number(new Date) - p < 550 && Math.abs(d) > 50 || Math.abs(d) > s / 2) ? a.flexAnimate(g, i.pauseOnAction) : u || a.flexAnimate(a.currentSlide, i.pauseOnAction, !0)
                    }
                    t.removeEventListener("touchend", f, !1), e = null, n = null, r = null, o = null
                }
                t.addEventListener("touchstart", (function(r) {
                    a.animating ? r.preventDefault() : 1 === r.touches.length && (a.pause(), s = l ? a.h : a.w, p = Number(new Date), o = d && c && a.animatingTo === a.last ? 0 : d && c ? a.limit - (a.itemW + i.itemMargin) * a.move * a.animatingTo : d && a.currentSlide === a.last ? a.limit : d ? (a.itemW + i.itemMargin) * a.move * a.currentSlide : c ? (a.last - a.currentSlide + a.cloneOffset) * s : (a.currentSlide + a.cloneOffset) * s, e = l ? r.touches[0].pageY : r.touches[0].pageX, n = l ? r.touches[0].pageX : r.touches[0].pageY, t.addEventListener("touchmove", v, !1), t.addEventListener("touchend", f, !1))
                }), !1)
            },
            resize: function() {
            ...
            var o, s = (o = e || (a.itemW + i.itemMargin) * a.move * a.animatingTo, -1 * function() {
                if (d) return "setTouch" === t ? e : c && a.animatingTo === a.last ? 0 : c ? a.limit - (a.itemW + i.itemMargin) * a.move * a.animatingTo : a.animatingTo === a.last ? a.limit : o;
                switch (t) {
                    case "setTotal":
            ...
            a.transitions && (s = l ? "translate3d(0," + s + ",0)" : "translate3d(" + s + ",0,0)", n = void 0 !== n ? n / 1e3 + "s" : "0s", a.container.css("-" + a.pfx + "-transition-duration", n)), a.args[a.prop] = s, (a.transitions || void 0 === n) && a.container.css(a.args)
        }, a.setup = function(t) {
            var n, r;
            u ? (a.slides.css({
                width: "100%",
                ...
                opacity: 1,
                zIndex: 2
            }) : a.slides.eq(a.currentSlide).fadeIn(i.animationSpeed, i.easing)), i.smoothHeight && m.smoothHeight()) : ("init" === t && (a.viewport = e('<div class="' + o + 'viewport"></div>').css({
                overflow: "hidden",
                position: "relative"
        ...
        if (void 0 === t && (t = {}), "object" == typeof t) return this.each((function() {
            var n = e(this),
                ...
                i = n.find(a);
            1 === i.length ? (i.fadeIn(400), t.start && t.start(n)) : null == n.data("flexslider") && new e.flexslider(this, t)
        }));
